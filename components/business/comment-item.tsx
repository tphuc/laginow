    ...
    return <>
        ...
        <div className="bg-gray-50 border-t border-gray-300 pt-2 w-full">
            ...
            <span className='flex flex-row items-center gap-2 text-indigo-900 my-2'>
                ...
                <div onClick={onUserLike} className={cn("flex border border-gray-300 text-gray-500 cursor-default flex-row p-1 gap-1  hover:bg-gray-100 hover:text-indigo-800 rounded-md items-center", {
                ...
                <div onClick={onUserDislike} className={cn("flex border border-gray-300 text-gray-500 cursor-default flex-row p-1 gap-1  hover:bg-gray-100 hover:text-indigo-800 rounded-md items-center", {
