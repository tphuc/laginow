        ...
        <div className="flex-1 h-auto flex flex-col items-start justify-start">
            <div className="grid w-full grid-cols-1 gap-2 grid-rows-auto sm:grid-cols-2 md:grid-cols-3">
                ...
                <div className="p-4 w-full border min-w-[160px] flex flex-col gap-1 border-gray-200 bg-white shadow-sm rounded-lg">
                    ...
                    <h2 className="text-2xl text-slate-700 font-display">1202</h2>
                ...
                <div className="p-4 w-full border min-w-[160px] flex flex-col gap-1 border-gray-200 bg-white shadow-sm rounded-lg">
                    ...
                    <h2 className="text-2xl text-slate-700 font-display">4.7</h2>
                ...
                <div className="p-4 w-full border min-w-[160px] flex flex-col items-start gap-1 border-gray-200  bg-gradient-to-br from-amber-50  to-red-50 shadow-sm rounded-lg">
                    ...
                    <div className={clsx("rounded-full cursor-pointer inline-flex items-center gap-2 text-sm bg-gray-300/40 p-2 px-3 text-display float-right transition-all", 
            ...
            <div className="p-2 flex flex-col gap-2 bg-white rounded-lg shadow-s border border-gray-200">
                ...
                <div className="px-3 py-2 cursor-pointer flex flex-col text-gray-700 bg-gray-100  rounded-lg hover:bg-sky-600 hover:text-white">
                    <div className="flex flex-row items-center justify-between">
                        <CalendarPlus />
                        <div className={clsx("rounded-full shadow shadow-sm flex items-center gap-1 text-sm bg-gray-300/40 p-1 px-2.5 text-display float-right transition-all")}>
                            chưa hoàn thành
                            <X size={16} />
                        </div>
                    </div>
                    <span className="mt-1 font-display">Thêm ảnh</span>
                    <span className="text-sm">Chọn tối đa 3 ảnh nổi bật cho trang</span>
                </div>

                <div className={clsx("px-3 py-2 cursor-pointer flex flex-col text-gray-600 bg-gray-100  rounded-lg hover:bg-sky-600 hover:text-white")}>
                    <div className="flex flex-row items-center justify-between">
                        <CalendarPlus />
                        <div className={clsx("rounded-full flex items-center gap-1 text-sm bg-gray-300/40 p-1 px-2.5 text-display float-right transition-all", {
                    ...
                    <span className="mt-1 font-display">Thông tin giờ hành chính</span>
