    ...
    <Layout>
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        >
          ...
          <motion.h1
            className="bg-gradient-to-br from-indigo-800 to-stone-500 bg-clip-text text-center  text-4xl font-bold tracking-[-0.02em] text-transparent drop-shadow-sm md:text-7xl md:leading-[5rem]"
